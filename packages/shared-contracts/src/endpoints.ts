...
export const API_ENDPOINTS = {
  ...
  fund_lookthrough: { method: 'POST', path: '/fund/lookthrough' },
  ...
  tdx_formulas_create: { method: 'POST', path: '/tdx/formulas' },
...
export const ENGINE_ENDPOINTS = {
  ...
  stocks_search: { method: 'POST', path: '/engine/stocks/search' },
  ...
  factors_meta: { method: 'GET', path: '/engine/factors/meta' },
